...
```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-variancewd@esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/stats-base-variancewd/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/stats-base-variancewd/actions/workflows/test.yml?query=branch:main
